...
public class InProgressTaskItemsAutoCompleteProvider : IAutoCompleteProvider
{
    ...
    public InProgressTaskItemsAutoCompleteProvider(BoardResolver boardResolver)
    {
    ...
    public async ValueTask<IEnumerable<DiscordAutoCompleteChoice>> AutoCompleteAsync(AutoCompleteContext context)
    {
        ...
        var response = taskItems.GetAutoCompleteStrings(BoardStatus.InProgress, boardNames);
